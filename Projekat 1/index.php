...
<?php if(!isset($_SESSION['login_user'])) : { ?>
    ...
    <?php  } else : { ?>
    <h4>Dobro došli <?php echo $login_session; ?></h4> 
    ...
    <div id="main">
        ...
        <div class="row" style="padding-top: 60px;">
            ...
            <div class="col-sm-6">
                ...
                <a href="kuvarzabebe.php">
                    <h3>Kuvar za bebe</h3>
                </a>
                <a href="kuvarbezglutena.php">
                    <h3>Kuvar - bez glutena</h3>
                </a>
            ...
            <div class="col-sm-6">
                ...
                <a href="selektujtenamirnice.php">
                    <h3>Selektujete namirnice</h3>
